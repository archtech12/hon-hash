            ...
            <div className="md:w-1/2 w-full">
              {submitSuccess && (
                <div className="mb-6 p-4 bg-green-600 rounded-lg flex items-center">
                  ...
                  Thank you for subscribing! You'll receive updates from Hon. Hassan Shehu Hussain (Hon. HASH) soon.
                </div>
              )}
              ...
              <p className="mt-3 text-green-200 text-sm">
                By subscribing, you agree to receive updates from Hon. Hassan Shehu Hussain (Hon. HASH). You can unsubscribe at any time.
              </p>
            </div>
          </div>
        </div>
