...
export function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap bg-green-700 text-white px-4 sm:px-6 md:px-8 lg:px-16 py-3 sm:py-4 shadow-lg sticky top-0 z-50">
      ...
      {isMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-green-900/95 backdrop-blur-xl shadow-2xl lg:hidden z-50 border-t border-white/10 animate-fade-in-up origin-top">
          <nav className="flex flex-col py-2">
            ...
            <Link
              ...
              onClick={closeMenu}
            >
              <i className="fa-solid fa-id-card text-xl w-6 text-center"></i>
