            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
              <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                ...
                <div className="mt-2 space-y-1">
                  <p className="text-sm font-semibold text-gold-400">Member House of Representatives Nassarawa Federal Constituency, Kano State</p>
                  <p className="text-xs text-gold-400/80 uppercase">DEPUTY CHAIRMAN HOUSE COMMITTEE ON CUSTOMS AND EXCISE</p>
                </div>
              </div>
            ...
            <div className="mt-10 pt-8 border-t border-green-700/50 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex space-x-4 sm:space-x-6">
                ...
                >
                  ...
                  <a
                    className="text-gray-400 hover:text-white transition-all hover:scale-110 p-2 hover:bg-white/10 rounded-full"
                    href="#"
