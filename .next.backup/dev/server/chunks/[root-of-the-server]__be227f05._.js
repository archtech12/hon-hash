...
const MOCK_PROJECTS = [
    ...
    {
        _id: 'proj-2',
        title: 'Job Recruitment Facilitation',
    ...
    // --- Empowerment: Vehicles & Mobility ---
    {
        ...
        description: 'Distribution of around 300 brand new Lifan motorcycles to youth leaders and supporters to enhance mobility and economic independence.',
        category: 'Empowerment',
        images: [
    ...
    },
    {
        ...
        category: 'Community',
        images: [
            '/assets/images/gallery/0-Portraits-Official/ziyara-tudun-wada.jpg'
        ],
        status: 'Completed',
        date: '2024'
    },
    {
        ...
        category: 'Political',
        images: [
            '/assets/images/gallery/0-Portraits-Official/hon-with-gov-abba-k.jpg'
        ],
        status: 'Completed',
        date: '2024'
    },
...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://lqlfyeomlegqzdjljdmx.supabase.co") || 'https://placeholder.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || ("TURBOPACK compile-time value", "sb_publishable_H0k16VPEAXeV2gYC-CrlfQ_e2MW7IwU") || 'placeholder';
...
async function GET() {
    try {
        ...
        const { data: dbNews, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('news').select('*').order('created_at', {
            ascending: false
        });
        if (!error && dbNews && dbNews.length > 0) {
            ...
            const mergedNews = [
                ...
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_NEWS"]
            ];
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mergedNews);
        }
        // Fallback: just return codebase mock news
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_NEWS"]);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_NEWS"]);
    }
}
async function POST(request) {
    try {
        ...
        // Save to Supabase
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('news').insert([
            {
                title,
                excerpt: excerpt || '',
                content,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be227f05._.js.map